...
function page() {
    ...
    useEffect(() => {
        setIsLoading(true);
        axios
            .get(`${API_URL}airlines/flight-all`)
            .then((response) => {
                                    ...
                                    <div className="collapse collapse-horizontal" id="collapseWidthExample2">
                                        <div className="card card-body" style={{ width: 350, border: 'none' }}>
                                            <div class="form-check">
                                                ...
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked={filtersTransit.direct} onChange={() => toggleFilter("direct")} />
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                Transit
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault"  checked={filtersTransit.transit} onChange={() => toggleFilter("transit")}  />
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                Transit 2+
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault"  checked={filtersTransit.transit2plus} onChange={() => toggleFilter("transit2plus")} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="collapse collapse-horizontal" id="collapseWidthExample3">
                                        <div className="card card-body" style={{ width: 350, border: 'none' }}>
                                            <div class="form-check">
                                                ...
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked={filtersFacilities.baggage} onChange={() => toggleFilterFacilities("baggage")}/>
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                Meal
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault"  checked={filtersFacilities.meal} onChange={() => toggleFilterFacilities("meal")} />
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                Wifi
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked={filtersFacilities.wifi} onChange={() => toggleFilterFacilities("wifi")} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="collapse collapse-horizontal" id="collapseWidthExample4">
                                        <div className="card card-body" style={{ width: 350, border: 'none' }}>
                                            <div class="form-check">
                                                ...
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked={filtersDepartureTime["0-6"]} onChange={() => toggleFilterDeparture("0-6")} />
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                06:00 - 12:00
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked={filtersDepartureTime["6-12"]} onChange={() => toggleFilterDeparture("6-12")} />
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                12:00 - 18:00
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault"  checked={filtersDepartureTime["12-18"]} onChange={() => toggleFilterDeparture("12-18")} />
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                18:00 - 24:00
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked={filtersDepartureTime["18-24"]} onChange={() => toggleFilterDeparture("18-24")} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="collapse collapse-horizontal" id="collapseWidthExample5">
                                        <div className="card card-body" style={{ width: 350, border: 'none' }}>
                                            <div class="form-check">
                                                ...
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault"  checked={filtersArrivalTime["0-6"]} onChange={() => toggleFilterArrival("0-6")} />
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                06:00 - 12:00
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked={filtersArrivalTime["6-12"]} onChange={() => toggleFilterArrival("6-12")} />
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                12:00 - 18:00
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault"  checked={filtersArrivalTime["12-18"]} onChange={() => toggleFilterArrival("12-18")} />
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                18:00 - 24:00
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked={filtersArrivalTime["18-24"]} onChange={() => toggleFilterArrival("18-24")} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="collapse collapse-horizontal" id="collapseWidthExample6">
                                        <div className="card card-body" style={{ width: 350, border: 'none' }}>
                                            <div class="form-check">
                                                ...
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked={filtersAirlines.garudaId} onChange={() => toggleFilterAirlines("garudaId")} />
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                Air Asia
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked={filtersAirlines.airAsia} onChange={() => toggleFilterAirlines("airAsia")} />
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                Lion Air
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked={filtersAirlines.lionAir} onChange={() => toggleFilterAirlines("lionAir")} />
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                Singapore Airlines
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault"  checked={filtersAirlines.singaporeAirlines} onChange={() => toggleFilterAirlines("singaporeAirlines")} />
                                            </div>
                                            <div class="form-check">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                Citilink
                                                </label>
                                                <input style={{ marginLeft: 280, marginTop: -20 }} class="form-check-input" type="checkbox" value="" id="flexCheckDefault"  checked={filtersAirlines.Citylink} onChange={() => toggleFilterAirlines("Citylink")} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div key={index}>
                                            <div className={styles['box-master']} style={{ backgroundColor: 'white', marginTop: 20 }}>
                                                ...
                                                <div className={styles['main2-col']}>
                                                    ...
                                                    <div style={{ width: 100 }}><button id={styles['btn-sub']} type="button" class="btn btn-primary"><Link href={`/booking/bookingdetail/${flight.code}`}style={{ textDecoration: 'none', color: 'white' }}>Select</Link></button></div>
                                                </div>
                                            </div>
